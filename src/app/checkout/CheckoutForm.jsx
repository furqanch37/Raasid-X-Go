  ...
  return (
    <form className="checkout-form" onSubmit={handleSubmit}>
      ...
      <section>
        ...
        <select required value={formData.shippingMethod} onChange={(e) => onChange('shippingMethod', e.target.value)}>
      ...
      <section>
        ...
        <select required value={formData.paymentMethod} onChange={(e) => onChange('paymentMethod', e.target.value)}>
